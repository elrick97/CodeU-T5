  ...
  fetch('/login-status')
      ...
      .then((loginStatus) => {
        if (loginStatus.isLoggedIn) {
          ...
          listElem.appendChild(createListItem(createLink(
              '/logout' + loginStatus.username, 'Logout')));
        } else {
