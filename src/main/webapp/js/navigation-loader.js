  ...
  fetch('/login-status')
      ...
      .then((loginStatus) => {
        if (loginStatus.isLoggedIn) {
          var xmlString = "<nav class=\"navbar navbar-expand-md navbar-dark fixed-top bg-primary\"><a class=\"navbar-brand\" href=\"#\">CodingPool</a><button class=\"navbar-toggler\" type=\"button\" data-toggle=\"collapse\" data-target=\"#navbarCollapse\" aria-controls=\"navbarCollapse\" aria-expanded=\"false\" aria-label=\"Toggle navigation\"><span class=\"navbar-toggler-icon\"></span></button><div class=\"collapse navbar-collapse\" id=\"navbarCollapse\"><ul id=\"navList\" class=\"navbar-nav mr-auto\"><li class=\"nav-item active\"><a class=\"nav-link\" href=\"/\">Home<span class=\"sr-only\">(current)</span></a></li><li class=\"nav-item\"><a class=\"nav-link\" href=\"/feed.html\">Feed</a></li><li class=\"nav-item\"><a class=\"nav-link\" href=\"/chart.html\">Chart</a></li><li class=\"nav-item\"><a class=\"nav-link\" href=\"/stats.html\">Stats</a></li><li class=\"nav-item\"><a class=\"nav-link\" href=\"/logout\">Logout</a></li><li class=\"nav-item\"><a class=\"nav-link\" href=\"/login\">Login</a></li></ul></div></nav>";
